            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-lg-offset-0">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                <button type="button" class="btn btn-primary" onclick="javascript:history.go(-1)"><i class="fa fa-arrow-left"></i> Kembali</button>
                                <button type="reset" class="btn btn-default"><i class="fa fa-undo"></i> Reset</button>
                                <button type="submit" class="btn btn-success pulll-right"><i class="fa fa-save"></i> Simpan</button>
                            </div>
                        </div>
                    </div>
                </div>
